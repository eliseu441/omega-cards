...
const Home = () => {
  ...
  const [services] = useState([
    ...
    { id: 3, link: '/',name: 'Combo camisa+baralho', description: 'Pacote completo de corte e barba', price: 'R$ 70', details: 'Pacote promocional para quem compra uma camisa com a mesma coleção do baralho pelo link combinado.', genericDetails: 'Pacote econômico para um visual completo.' },
  ]);
